...
sites_hashes.each do | hash |
  ...
  @browser.get_pixeled(pixel_link, hash['campaign_name'], hash['campaignId'], hash['siteId'])
  ...
  pixel_data = pixel_report(pixel_link, hash['siteId'],hash['campaign_name'],hash['campaignId'],hash['advertiserId'], pixel_cutoff, pixel,test_tag)
